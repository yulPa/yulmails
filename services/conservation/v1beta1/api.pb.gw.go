...
func request_ConservationService_CreateConservation_0(ctx context.Context, marshaler runtime.Marshaler, client ConservationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Conservation
	var metadata runtime.ServerMetadata
	...
	msg, err := client.CreateConservation(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterConservationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConservationServiceClient) error {
	...
	mux.Handle("POST", pattern_ConservationService_CreateConservation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_ConservationService_CreateConservation_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ConservationService_CreateConservation_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_ConservationService_CreateConservation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "conservation"}, ""))
)

var (
	forward_ConservationService_ListConservation_0 = runtime.ForwardResponseStream

	forward_ConservationService_CreateConservation_0 = runtime.ForwardResponseMessage
)
